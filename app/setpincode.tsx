...
const SetPincode = () => {    
    ...
    const { dismiss } = useBottomSheetModal(); // Hook to manage bottom sheet state
    ...
    const handlePresentModalPress = () => {
        router.push({pathname: '/confirmpincode'});
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <SafeAreaView style={{ flex: 1, alignItems: "center" }}>
                    <View style={{ padding: 10, paddingVertical: 50, gap: 10 }}>
                        <Text style={{ fontSize: 28, fontFamily: "Quicksand-Bold" }}>Set up your Pin Code</Text>
                        <Text style={{ fontFamily: "Quicksand-Medium", fontSize: 18 }}>Choose a PIN that you can remember and that no one can guess to protect your information</Text>
                        <CodeField
                            ref={ref}
                            {...props}
                            value={code}
